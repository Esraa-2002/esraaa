  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Row(
        ...
        children: [
          Text("12:00  AM",style: TextStyle(fontSize: 20,color: Colors.grey),),
          SizedBox(width: 300,),
    ...
    SizedBox(width: 70,),
                ...
                Text( 'سجل الطلاب',style:TextStyle(fontSize: 18,fontWeight:FontWeight.normal,color:Colors.white  ) ,),
                SizedBox(width: 10,),
